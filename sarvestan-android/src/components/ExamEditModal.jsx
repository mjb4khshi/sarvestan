        ...
        <div className="fixed inset-0 z-[85] flex items-end sm:items-center justify-center p-0 sm:p-4">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="overflow-y-auto py-3 space-y-3.5 flex-1 pr-0.5">
              ...
              {/* تاریخ شمسی امتحان و ساعت امتحان */}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full pl-3.5 pr-8 py-2.5 rounded-xl bg-base border border-base-500/30 text-base-content text-[13px] font-mono font-bold focus:border-primary outline-none transition text-left"
                        dir="ltr"
                        required
                      />
                      <CalendarDays className="w-4 h-4 text-neutral/60 absolute right-2.5 top-3 pointer-events-none" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        dir="ltr"
                      />
                      <Clock className="w-4 h-4 text-neutral/60 absolute right-2.5 top-3 pointer-events-none" />
                    </div>
                  </div>
                </div>
              </div>
